...
{{< groupitem
  ...
  desc="Jonathan is broadly interested in multi-robot planning and tasking. His work focuses on developing algorithms that account for how a robot’s actions affect its own systems, how the environment influences its behavior, and how individual robots coordinate within a team, using both centralized and decentralized algorithms. Jonathan earned his PhD in Robotics in 2025 at the Colorado School of Mines, where he was advised by Qi Han and was a member of the Pervasive Computing Systems (PeCS) research group. He also completed a master’s degree in Computer Science at Mines in 2022 and a bachelor’s degree in Computer Science, with minors in Mathematics and Mechatronics Technologies, at Penn State Harrisburg in 2020."
  image="/img/group/current/jonathan_diller.jpg"
  url=""
>}}
...
{{< groupitem
  ...
  pos="PhD student, ESE"
  desc="Zac develops robots that can reason, plan, and collaborate in complex environments while adhering to physical and contextual safety constraints. His research focuses on closed-loop planning with foundation models, multi-robot collaboration, and safety for AI-enabled robotic systems. He is co-advised by Prof. Vijay Kumar and Prof. George Pappas."
  image="/img/group/current/zac_ravichandran.jpg"
